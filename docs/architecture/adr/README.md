...
DFAT ADRs capture research-oriented design choices for the DSR artefact.

| ADR | Title |
|-----|--------|
| [ADR-001](ADR-001-design-science-research.md) | Design Science Research Methodology |
| [ADR-002](ADR-002-local-llm-only.md) | Local LLM Only — No Cloud Inference |
| [ADR-003](ADR-003-dual-output-report.md) | Dual-Output Report Format |
